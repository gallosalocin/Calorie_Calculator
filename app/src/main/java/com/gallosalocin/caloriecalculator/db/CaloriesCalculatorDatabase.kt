    ...
    class Callback @Inject constructor(
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                ...
                categoryDao.insertCategory(Category(8, "Recipe", Color.parseColor("#F5F5F5")))
                ...
                foodDao.insertFood(Food(id = 15, name = "Beurre de cacahuètes", categoryId = 6, calories = 93F, weight = 15, fats = 7.5F, carbs = 1.1F, prots = 4.5F))
                ...
                foodDao.insertFood(Food(id = 18, name = "Féta", categoryId = 6, calories = 103F, weight = 40, fats = 8.4F, carbs = 0.3F, prots = 6.8F))
                ...
                foodDao.insertFood(Food(id = 21, name = "Bûche de chèvre", categoryId = 6, calories = 87F, weight = 30, fats = 6.9F, carbs = 0.4F, prots = 6F))
                ...
                foodDao.insertFood(Food(id = 26, name = "Noix", categoryId = 6, calories = 105F, weight = 15, fats = 9.6F, carbs = 1.7F, prots = 2.3F))
                ...
                foodDao.insertFood(Food(id = 35, name = "Laitue", categoryId = 3, calories = 30F, weight = 200, fats = 0.4F, carbs = 2.6F, prots = 2.6F))
                ...
                foodDao.insertFood(Food(id = 48, name = "Pêche", categoryId = 5, calories = 39F, weight = 100, fats = 0.33F, carbs = 9F, prots = 1.08F))
                ...
                foodDao.insertFood(Food(id = 58, name = "Flocons d'avoine", categoryId = 2, calories = 236F, weight = 65, fats = 4.3F, carbs = 38.3F, prots = 7.8F))
                foodDao.insertFood(Food(id = 59, name = "Gaufre au miel", categoryId = 2, calories = 481F, weight = 100, fats = 20F, carbs = 69F, prots = 4.8F))
                foodDao.insertFood(Food(id = 60, name = "Miel", categoryId = 2, calories = 301F, weight = 100, fats = 0F, carbs = 75F, prots = 0.2F))
                foodDao.insertFood(Food(id = 61, name = "Patate", categoryId = 2, calories = 82F, weight = 100, fats = 0.1F, carbs = 18.3F, prots = 1.8F))
                foodDao.insertFood(Food(id = 62, name = "Pâtes blé complet", categoryId = 2, calories = 360F, weight = 100, fats = 2F, carbs = 70F, prots = 13F))
                foodDao.insertFood(Food(id = 63, name = "Pita", categoryId = 2, calories = 248F, weight = 100, fats = 1F, carbs = 50F, prots = 8.2F))
                ...
                foodDao.insertFood(Food(id = 75, name = "Maïs en boite", categoryId = 2, calories = 76F, weight = 100, fats = 1.7F, carbs = 11F, prots = 2.8F))
                ...
                foodDao.insertFood(Food(id = 82, name = "Salade de poulet", categoryId = 8, calories = 648F, weight = 100, fats = 24.7F, carbs = 40.7F, prots = 60.6F))
                foodDao.insertFood(Food(id = 83, name = "Petit Dej", categoryId = 8, calories = 556F, weight = 100, fats = 18.1F, carbs = 75.1F, prots = 22.3F))
                foodDao.insertFood(Food(id = 84, name = "Soupe de poulet", categoryId = 8, calories = 411F, weight = 100, fats = 4.5F, carbs = 43.6F, prots = 48.1F))
