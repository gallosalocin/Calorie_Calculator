    ...
    class Callback @Inject constructor(
        ...
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            applicationScope.launch {
                ...
                foodDao.insertFood(Food(id = 18, name = "Féta Dodonis", categoryId = 6, calories = 103F, weight = 40, fats = 8.4F, carbs = 0.3F, prots = 6.8F))
                ...
                foodDao.insertFood(Food(id = 57, name = "Burger", categoryId = 2, calories = 231F, weight = 80, fats = 4.7F, carbs = 38.4F, prots = 7.8F))
                foodDao.insertFood(Food(id = 58, name = "Flocons d'avoine Prozis", categoryId = 2, calories = 236F, weight = 65, fats = 4.3F, carbs = 38.3F, prots = 7.8F))
